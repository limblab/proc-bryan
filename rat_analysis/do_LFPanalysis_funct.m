...
[channels, ~] = ismember(LFP_struct.ch, channels);
...
%
%
[b,a] = butter(2,[58 62]/(LFP_struct.freq(1)/2),'stop');
epiduralData = filtfilt(b,a,double(epiduralData)')';

LFP_struct.filteredEpiduralData = do_CAR(epiduralData);
LFP_struct.filteredEpiduralData.rawEpidural = epiduralData;
